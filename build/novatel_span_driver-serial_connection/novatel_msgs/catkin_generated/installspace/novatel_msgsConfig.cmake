...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'novatel_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/husai/16_novatel_span_driver/install/${idir}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>, Ian Colwell <icolwell@gsd.uwaterloo.ca>, Josh Whitley <jwhitley@autonomoustuff.com>' to fix it.")
    endif()
