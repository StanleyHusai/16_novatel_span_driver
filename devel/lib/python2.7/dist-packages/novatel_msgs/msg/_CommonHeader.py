...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_H2B2H2BH2I2H.pack(_x.id, _x.msg_type, _x.port_addr, _x.length, _x.sequence, _x.idle_time, _x.time_status, _x.gps_week, _x.gps_week_seconds, _x.receiver_status, _x.reserved, _x.software_version))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.msg_type, _x.port_addr, _x.length, _x.sequence, _x.idle_time, _x.time_status, _x.gps_week, _x.gps_week_seconds, _x.receiver_status, _x.reserved, _x.software_version,) = _struct_H2B2H2BH2I2H.unpack(str[start:end])
      return self
